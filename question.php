        ...
        <div class="content">
          ...
          <div class="your-answer">
            ...
            <div class="editor-toolbar">
              ...
              <button title="Link"><span>🔗</span></button>
              <button title="Quote"><span>"</span></button>
              <button title="Code"><span>{}</span></button>
              <button title="Image"><span>📷</span></button>
              <button title="Snippet"><span>⌨️</span></button>
              <div class="separator"></div>
              <button title="Numbered list"><span>1.</span></button>
              <button title="Bulleted list"><span>•</span></button>
              <div class="separator"></div>
              <button title="Undo"><span>↩</span></button>
              <button title="Redo"><span>↪</span></button>
